...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | SharaForms collects anonymous usage data to help improve the product. This
    ...
    | SHARAFORMS_ANONYMOUS_TELEMETRY_DISABLED to true.
    |
    | What is collected:
    ...
    */
    ...
    'enabled' => !env('SHARAFORMS_ANONYMOUS_TELEMETRY_DISABLED', false),
    ...
    | This is hardcoded for SharaForms telemetry collection.
    |
    */

    'endpoint' => 'https://telemetry.sharaforms.com/track',
    ...
    |--------------------------------------------------------------------------
    |
    | OpenPanel client ID for SharaForms telemetry authentication.
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | OpenPanel client secret for SharaForms telemetry authentication.
    | Hardcoded - users do not need to configure this.
    |
    */
