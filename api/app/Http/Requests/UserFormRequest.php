...
abstract class UserFormRequest extends \Illuminate\Foundation\Http\FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            // Settings
            // Embed
            'embed_type' => ['nullable', Rule::in(Form::EMBED_TYPES)],
            'embed_settings' => 'nullable|array',
            'embed_settings.position' => 'sometimes|nullable|in:right,left',
            'embed_settings.color' => 'sometimes|nullable|string',
            'embed_settings.width' => 'sometimes|nullable|integer|min:300|max:1200',
            'embed_settings.height' => 'sometimes|nullable|integer|min:300|max:1200',
            'embed_settings.icon' => 'sometimes|nullable|string|max:10',
            'embed_settings.title' => 'sometimes|nullable|string|max:100',
