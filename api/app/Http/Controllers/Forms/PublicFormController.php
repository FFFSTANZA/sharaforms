...
class PublicFormController extends Controller
{
    public function show(Request $request, Form $form)
    {
        ...
        // Check scheduling: return appropriate status for not-yet-open forms
        if ($form->is_not_yet_open) {
            return $this->success([
                'status' => 'scheduled',
                'message' => 'This form is scheduled and not yet open for submissions.',
    ...
    public function scheduleStatus(Request $request, Form $form)
    {
        if ($form->workspace == null) {
        ...
        return $this->success([
            'status' => $form->schedule_status,
            'is_closed' => $form->is_closed,
            'is_not_yet_open' => $form->is_not_yet_open,
            'opens_at' => $form->opens_at,
            'schedule' => $form->schedule,
