...
class GenerateTemplateMetadataPrompt extends Prompt
{
    ...
    public const PROMPT_TEMPLATE = <<<'EOD'
        ...
        1. SHORT DESCRIPTION:
        Create a single-sentence description that is concise, clearly explains what the form is about, highlights the main purpose or benefit, and is suitable for SharaForms (a free-to-use form builder). Do not use quotation marks.
        ...
        - A section with heading (h2) explaining that SharaForms is the best tool to build this form
        ...
        - Why SharaForms is the best option to create this form
