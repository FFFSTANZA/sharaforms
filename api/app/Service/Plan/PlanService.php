...
class PlanService
{
     ...
     * Checks all subscriptions and picks the highest tier.
     */
    public function computeUserTier(User $user): string
    {
        // Check all subscriptions and pick highest tier
    ...
    {
        // Use workspace's caching mechanism
