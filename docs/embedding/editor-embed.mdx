...
description: "Listen to postMessage events from the SharaForms form editor when embedded in your CMS or application"
---
...
<Warning>
Editor embedding is available only to approved SharaForms partners with a signed agreement. If SharaForms has not enabled this option for your organization, embedding the editor on your site will not work. To discuss partner access, contact [team@sharaforms.com](mailto:team@sharaforms.com).
</Warning>
