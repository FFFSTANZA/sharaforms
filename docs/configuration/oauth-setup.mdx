...
description: Complete guide to configuring OAuth integrations for Google, Stripe, and Telegram in SharaForms
---

SharaForms supports several OAuth integrations that enable users to connect external services for enhanced functionality. This guide covers setting up Google, Stripe, and Telegram OAuth integrations.

<Info>
SharaForms handles OAuth redirect URLs automatically. You don't need to manually configure redirect URLs in your OAuth applications - the system generates them dynamically based on your domain configuration.
</Info>

<Card title="Developer Guide" icon="code" href="/contributing/new-integration">
If you're looking to add a new OAuth integration to SharaForms, check out the complete developer guide with architecture overview and implementation steps.
</Card>
...
- **Automatic Scope Management**: SharaForms requests appropriate permissions based on usage
...
<Step title="Configure OAuth Consent Screen">
    ...
    4. Add scopes if needed (SharaForms handles this automatically)
...
<Step title="Create OAuth Credentials">
    ...
    4. Add authorized origins:
       ...
       ```
    5. Leave redirect URIs empty - SharaForms handles these automatically
...
Stripe OAuth enables payment processing capabilities within SharaForms, allowing you to collect payments through your forms.
...
<Step title="Configure Platform Settings">
    ...
    3. Configure **Redirect URIs** (SharaForms handles these automatically)
...
Telegram OAuth enables notification integration, allowing SharaForms to send form submission alerts to Telegram chats.
...
<Step title="Test Your Bot">
    ...
    2. Connect the bot in SharaForms's integration settings
...
<Accordion title="Google OAuth Issues">
    **Common problems and solutions:**
    ...
    - **"Invalid redirect URI"**: SharaForms handles redirects automatically - don't manually configure them
...
<Check>
With properly configured OAuth integrations, your SharaForms installation will support seamless user authentication and powerful third-party service integrations.
</Check> 