---
title: "Tech Stack"
description: "Overview of SharaForms's technology stack"
---

SharaForms is built using a modern and robust technology stack, ensuring high performance, scalability, and maintainability. Here's an overview of the main technologies used in the project:
...
<Card title="Laravel" icon="laravel" href="https://laravel.com/" horizontal>
  The PHP framework that powers the backend of SharaForms.
</Card>
...
This tech stack allows SharaForms to deliver a fast, responsive, and feature-rich form building experience. For detailed installation instructions and system requirements, please refer to our [Docker deployment guide](deployment/docker) or [Local deployment guide](deployment/local-deployment).
