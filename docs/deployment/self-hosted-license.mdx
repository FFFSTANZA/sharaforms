...
description: Understand Community and Enterprise features for self-hosted SharaForms installations
---

SharaForms is licensed under AGPLv3. You can self-host the core product without an Enterprise license.

SharaForms also includes Enterprise features under a separate Enterprise License. These features are built for teams that need stronger identity controls, branding, auditability, and workspace-level administration while helping fund ongoing development of the project.

<Info>
    Enterprise code is included with the SharaForms repository and Docker images,
...
| ---------- | --------------------- | ---------------------- |
| Run SharaForms for personal use | Yes | Yes |
| Run SharaForms for commercial use | Yes | Yes |
...
Community self-hosted installations include the core SharaForms product:
...
Some SharaForms settings exist at two levels. The instance-wide configuration is available to self-hosted installations without an Enterprise license. The workspace-level Enterprise feature gives specific workspaces their own dedicated controls.
...
| Branding | Use core form customization options | Remove SharaForms branding and use advanced white-label controls |
...
<Note>
    ...
    SharaForms instance, and custom domains attached to workspaces or forms. See
...
To unlock Enterprise features on a self-hosted instance, activate a license key in SharaForms.
