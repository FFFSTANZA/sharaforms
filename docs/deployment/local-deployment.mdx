...
description: "Set up SharaForms locally for development"
---
...
If you prefer to set up SharaForms manually or can't use Docker, follow the instructions below.
...
2. Clone the repository and install dependencies:
    ...
    ```bash
    git clone https://github.com/SharaForms/SharaForms && cd SharaForms
...
6. Set up Herd:
   For detailed instructions on setting up Herd, refer to the [Herd documentation](https://herd.laravel.com/docs).
    ...
    - Add your SharaForms's `api` directory to Herd
...
7. Access your local SharaForms installation:
    - The API will be available at the domain provided by Herd (e.g., `http://sharaforms.test`)
