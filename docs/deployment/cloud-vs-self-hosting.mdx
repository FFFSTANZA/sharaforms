...
description: "Understand the differences between cloud and self-hosting options for SharaForms"
---

When deciding between using SharaForms's cloud service or self-hosting, it's important to understand the key differences and benefits of each option. Below is a comparison to help you make an informed decision:

<Info>
    Self-hosting SharaForms does not require an Enterprise license for core
...
| Where your money goes      | 3rd-party services                               | Improving SharaForms                  |

### When Should You Self-Host?

There are specific scenarios where self-hosting SharaForms might be the better choice:

- **Regulatory Compliance**: If you need an air-gapped environment for regulatory reasons (e.g., HIPAA compliance).
- **Custom Builds**: If you want to run a custom build or fork of SharaForms with your own customizations.
- **Custom Integrations**: If you need to use community or custom integrations that are not supported in the cloud version.

For most users, the managed SharaForms Cloud service will be the better option due to its ease of use, automatic updates, and comprehensive support.
