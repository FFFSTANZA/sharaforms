...
export const optionSelectorInputTheme = {
  ...
  variants: {
    theme: {
      default: {
        option: ['hover:bg-neutral-100 dark:hover:bg-neutral-900']
      },
      minimal: {
        option: ['border-2 border-transparent', 'bg-neutral-100 dark:bg-notion-dark-light', 'hover:bg-neutral-200/50 dark:hover:bg-neutral-900']
      },
      notion: {
        option: ['border-notion-input-border dark:border-notion-input-borderDark', 'hover:backdrop-brightness-95']
      },
      transparent: {
        option: ['bg-transparent', 'hover:bg-neutral-50 dark:hover:bg-neutral-900']
      }
    },
    size: {
