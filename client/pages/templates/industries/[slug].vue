  ...
  script: [
    {
      ...
      textContent: JSON.stringify({
        ...
        keywords: `free form templates, ${industry.value?.name || 'industry'} form templates, free form builder, unlimited submissions, built-in calculators, no-code form templates`,
        isPartOf: {
