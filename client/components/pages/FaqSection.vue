  ...
  <section class="py-12 sm:py-20 px-8 lg:px-12 bg-white">
    <div class="mx-auto max-w-266">
      <div class="text-center">
        <p
          class="text-base leading-7 tracking-[-1.1%] font-semibold brand-gradient-text"
        >
          {{ eyebrow }}
        </p>
        <h2
      ...
      <div class="mt-8 sm:mt-12">
        <div class="space-y-3 sm:space-y-4">
          ...
          >
            <button
              type="button"
              class="w-full p-4 sm:p-5 text-left rounded-2xl cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400"
        ...
        <div v-if="showContact" class="mt-8 text-center sm:mt-12">
          ...
          >
            ...
            <button
              type="button"
              class="cursor-pointer hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:ring-offset-2 brand-gradient-text"
              @click="$emit('contact')"
            >
              {{ contactLabel }}
            </button>
