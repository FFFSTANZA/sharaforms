  ...
  >
    ...
    >
      <template #stripe_id-cell="{ row }">
        <span
          class="text-xs select-all bg-neutral-50 border-neutral-200 text-neutral-600 rounded-md px-2 py-1 border inline-flex items-center gap-1"
        >
          <Icon name="lucide:credit-card" class="h-4 w-4 inline-block" />
