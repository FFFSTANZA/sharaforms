  ...
  <div>
    ...
    >
      <template #body>
        ...
        <div class="mb-6">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            >
              ...
              <span v-if="opt.locked" class="text-xs text-neutral-400 mt-1">
        ...
        <div class="border border-blue-300 bg-blue-50 dark:bg-notion-dark-light rounded-md p-4 mb-4 w-full select-all">
          <div class="flex items-center">
            <code class="select-all text-blue-600 flex-grow break-all text-xs leading-relaxed whitespace-pre-wrap">{{ embedCode }}</code>
            <div
              class="hover:bg-blue-100 rounded-sm transition-colors cursor-pointer flex-shrink-0 ml-2 p-1"
...
const settings = ref({
  ...
  color: props.form.embed_settings?.color || props.form.color || '#3B82F6',
...
function onOpenClick() {
  ...
  if (style === 'focused') {
    useAlert().warning('Focused mode forms do not support overlay embeds.')
    return
  }
