...
export default {
  ...
  computed: {
    embedCode() {
      ...
      return `${this.iframeCode}<script src="${appUrl("/widgets/sharaforms-sdk.min.js")}"><\/script>
<script>
...
${resizeComment}
  ...
  // More SDK methods: sharaforms.get('${this.form.slug}').setField(id, value)
  // Docs: https://docs.sharaforms.com/embedding/javascript-sdk
<\/script>`
    },
    iframeCode() {
