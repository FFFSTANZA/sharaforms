          ...
          >
            ...
            >
              <div class="mx-auto mb-4 max-w-lg text-center">
                <div class="mx-auto mb-3 flex h-9 w-9 items-center justify-center rounded-lg bg-neutral-100 text-neutral-600">
                  <Icon
            ...
            >
              ...
              <div class="p-4 sm:p-5">
                <div class="mb-4">
                  ...
                  <p class="mt-1 text-sm text-neutral-500">
                    {{ useFeatureFlag('ai_features') ? 'Start from a prompt, a template, an import, or a blank form.' : 'Start from a template, an import, or a blank form.' }}
                  </p>
                </div>
                ...
                >
                  <div class="flex items-center justify-between gap-3 border-b border-neutral-100 bg-neutral-50/80 px-3 py-2">
                    <div class="flex items-center gap-2">
                      <span class="flex h-7 w-7 items-center justify-center rounded-md bg-neutral-100 text-neutral-600">
                        <Icon
                  ...
                  <TrackClick name="select_form_base" :properties="{ base: 'contact-form' }">
                    ...
                    >
                      <div class="flex items-center justify-between gap-3">
                        <span class="flex h-9 w-9 items-center justify-center rounded-lg bg-neutral-100 text-neutral-600">
                          <UIcon
                      ...
                      <div class="mt-4">
                        <p class="font-semibold text-neutral-950">Start from Scratch</p>
                        <p class="mt-1 text-xs leading-5 text-neutral-500">Create a blank form from scratch.</p>
                      </div>
                    </button>
                  </TrackClick>
                  <div
