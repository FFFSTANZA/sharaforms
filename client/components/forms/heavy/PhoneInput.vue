      ...
      >
        <template #option="props">
          <div class="flex items-center gap-2 max-w-full">
            ...
            <span class="text-gray-500 dark:text-neutral-400 whitespace-nowrap" :class="ui.option({ class: props.ui?.slots?.option })">{{ props.option.dial_code && props.option.dial_code.startsWith('+') ? props.option.dial_code : '+' + props.option.dial_code }}</span>
          </div>
        </template>
