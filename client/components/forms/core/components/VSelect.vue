<template>
  ...
  >
    <UPopover
      ...
      :ui="{
        content: 'bg-white dark:!bg-notion-dark-light shadow-xl z-30 overflow-auto border border-neutral-200 dark:border-neutral-700 ' + borderRadiusClass
      }"
    >
      <template #anchor>
        <div
              ...
              <div
                ...
                :class="[
                  ...
                  { 'pr-9': multiple},
                  {
                    ...
                    'cursor-pointer hover:bg-neutral-100 dark:hover:bg-neutral-800': filteredOptions[virtualItem.index] && !disabledOptionsMap[filteredOptions[virtualItem.index][optionKey]],
                    'bg-neutral-100 dark:bg-neutral-800': highlightedIndex === virtualItem.index
                  }
                ]"
              ...
              <div
                ...
                :class="[
                  ...
                  { 'pr-9': multiple},
                  {
                    ...
                    'cursor-pointer hover:bg-neutral-100 dark:hover:bg-neutral-800': !disabledOptionsMap[option[optionKey]],
                    'bg-neutral-100 dark:bg-neutral-800': highlightedIndex === index
                  }
                ]"
...
export default {
  ...
  props: {
    ...
    color: { type: String, default: '#EA6676' },
    ...
    chevronIcon: { type: String, default: 'lucide:chevrons-up-down' }
  },
