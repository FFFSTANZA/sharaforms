...
// Create writable refs from props (toRef on props is readonly, which blocks writes)
const darkModeRef = ref(props.darkMode)
watch(() => props.darkMode, (val) => { darkModeRef.value = val })
const modeRef = ref(props.mode)
watch(() => props.mode, (val) => { modeRef.value = val })
