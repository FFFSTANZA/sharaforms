<template>
  <div v-if="isFocusedMode" class="px-4 mt-6">
    <EditorSectionHeader icon="i-lucide-image" :icon-class="headerIconClass" title="Image" />
...
const layoutOptions = [
  { name: 'between',      icon: 'sharaforms:form-layout-between',      iconClass: iconBaseClass, iconSelectedClass },
  { name: 'left-small',   icon: 'sharaforms:form-layout-left-small',    iconClass: iconBaseClass, iconSelectedClass },
  { name: 'left-split',   icon: 'sharaforms:form-layout-left-split',    iconClass: iconBaseClass, iconSelectedClass },
  { name: 'background',   icon: 'sharaforms:form-layout-background',    iconClass: iconBaseClass, iconSelectedClass },
  { name: 'right-small',  icon: 'sharaforms:form-layout-right-small',   iconClass: iconBaseClass, iconSelectedClass },
  { name: 'right-split',  icon: 'sharaforms:form-layout-right-split',   iconClass: iconBaseClass, iconSelectedClass },
]
