<template>
  <div class="p-4">
    ...
    >
      <UIcon name="i-lucide-star" class="w-8 h-8 mb-2 opacity-50" />
        ...
        <div class="flex flex-col items-center justify-center sm:w-1/3 bg-neutral-50 rounded-xl p-4 border border-neutral-100">
          ...
          <div class="flex items-center gap-1 mb-2">
            <UIcon
              ...
              :key="i"
              :name="i <= Math.round(data.average || 0) ? 'i-lucide-star' : 'i-lucide-star'"
        ...
        <div class="flex-1 space-y-2 py-1">
          ...
          >
            <div class="flex items-center gap-1 w-12 flex-shrink-0 justify-end">
              ...
              <UIcon name="i-lucide-star" class="w-3 h-3 text-neutral-400" />
            </div>
