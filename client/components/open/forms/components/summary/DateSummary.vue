<template>
  <div class="p-4">
    ...
    >
      <UIcon name="i-lucide-calendar" class="w-8 h-8 mb-2 opacity-50" />
    ...
    <div v-else class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div class="flex items-start gap-4 p-4 bg-neutral-50 rounded-xl border border-neutral-100 relative overflow-hidden group">
        ...
        <UIcon name="i-lucide-clock" class="absolute -right-4 -bottom-4 w-24 h-24 text-neutral-100 opacity-50 transform rotate-12 group-hover:scale-110 transition-transform duration-500" />
      </div>
      ...
      <div class="flex items-start gap-4 p-4 bg-neutral-50 rounded-xl border border-neutral-100 relative overflow-hidden group">
        ...
        <!-- Decorative background element -->
        <UIcon name="i-lucide-calendar" class="absolute -right-4 -bottom-4 w-24 h-24 text-neutral-100 opacity-50 transform rotate-12 group-hover:scale-110 transition-transform duration-500" />
      </div>
    </div>
  </div>
</template>
