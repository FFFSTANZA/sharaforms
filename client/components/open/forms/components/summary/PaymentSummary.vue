<template>
  <div class="p-4">
    ...
    >
      <UIcon name="i-lucide-dollar-sign" class="w-8 h-8 mb-2 opacity-50" />
    ...
    <div v-else class="grid grid-cols-1 sm:grid-cols-3 gap-4">
      ...
      <div class="flex flex-col p-4 bg-emerald-50 rounded-xl border border-emerald-100">
        <div class="flex items-center gap-2 mb-2">
          <UIcon name="i-lucide-dollar-sign" class="w-4 h-4 text-emerald-600" />
      ...
      <div class="flex flex-col p-4 bg-neutral-50 rounded-xl border border-neutral-100">
        <div class="flex items-center gap-2 mb-2">
          <UIcon name="i-lucide-calculator" class="w-4 h-4 text-neutral-500" />
