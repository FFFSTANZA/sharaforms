    ...
    <div class="px-4">
      ...
      <OptionSelectorInput
        ...
        <OptionSelectorInput
          ...
          seamless
          :options="[
            { name: 'left', icon: 'i-lucide-align-left', tooltip: 'Align left' },
            { name: 'center', icon: 'i-lucide-align-center', tooltip: 'Align center' },
            { name: 'right', icon: 'i-lucide-align-right', tooltip: 'Align right' },
            { name: 'justify', icon: 'i-lucide-align-justify', tooltip: 'Justify text' },
          ]"
          :multiple="false"
          :columns="4"
        />
