        ...
        <div class="flex items-center justify-between gap-2">
          <div class="min-w-0">
            <div class="flex items-center gap-1 text-xs">
              ...
              <UIcon name="i-lucide-chevron-right" class="w-3 h-3 text-neutral-400" />
      ...
      <div v-else class="p-4">
        ...
        >
          <div class="w-12 h-12 rounded-full bg-neutral-100 dark:bg-neutral-700 flex items-center justify-center mx-auto mb-3">
            <UIcon name="i-lucide-mouse-pointer-click" class="w-6 h-6 text-neutral-400" />
          </div>
...
const getZoneIcon = (zone) => {
  if (zone.static_text !== undefined) return 'i-lucide-file-text'
  if (zone.static_image !== undefined) return 'i-lucide-image'
