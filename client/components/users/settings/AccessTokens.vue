    ...
    <div class="space-y-4 pt-8 border-t border-neutral-200">
      ...
      <div class="bg-neutral-50 border border-neutral-200 rounded-lg p-4">
        <div class="space-y-3">
          ...
          <div class="flex items-start gap-3">
            <UIcon name="i-lucide-shield-check" class="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
            <div>
          ...
          <div class="flex items-start gap-3">
            <UIcon name="i-lucide-clock" class="w-5 h-5 text-yellow-500 mt-0.5 flex-shrink-0" />
            <div>
              <h4 class="text-sm font-medium text-neutral-900">Rate Limits</h4>
              <p class="text-sm text-neutral-600 mt-1">
                API requests are rate limited. <a :href="`${sharaformsConfig.links.api_docs}#rate-limits`" target="_blank" class="text-blue-500 hover:underline">Check our documentation</a> for current limits and best practices.
              </p>
            </div>
          </div>
        </div>
