/* eslint-disable */
/**
 * SharaForms Local SDK Stub
 * Creates window.sharaforms early for custom code support
 * The real SDK (useSdkBridge) will enhance this when the form loads
 */
(function() {
  if (window.sharaforms) return
  ...
  window.addEventListener('message', function(event) {
    ...
    if (data.type && data.type.indexOf && data.type.indexOf('sharaforms:event') === 0) {
